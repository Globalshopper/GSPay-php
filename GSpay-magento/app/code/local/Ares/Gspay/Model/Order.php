...
*/
class Ares_Gspay_Model_Order
	extends Mage_Sales_Model_Order
{

    /**
     * Load order by system gsordid
     *
     * @param string $gsordid
     * @return Mage_Sales_Model_Order
     */
    public function loadByGsordId($gsordid)
    {
        return $this->loadByAttribute('gsordid', $gsordid);
    }
