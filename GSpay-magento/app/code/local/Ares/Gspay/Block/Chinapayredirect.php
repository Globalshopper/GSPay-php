...
class Ares_Gspay_Block_Chinapayredirect extends Mage_Core_Block_Abstract
{
	protected function _construct()
    {
        parent::_construct();
        //$this->setTemplate('gspay/chinapayredirect.phtml');
    }
	...
	protected function _toHtml()
	{
        ...
        $form->setAction($alipay->getChinapayUrl())
				->setId('gspaysubmit')
				->setName('gspaysubmit')
				->setMethod('POST')
		...
		$alipay->setpayRequest($payRequest);
						
		//chinapay表单数据
		$paramFields = $alipay->getChinapayParamFields();
